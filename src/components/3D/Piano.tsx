...
const PianoModel = (props: JSX.IntrinsicElements['group']) => {
  ...
  return (
    <group {...props} dispose={null}>
      <group position={[0.918, 0, -1.541]} rotation={[-Math.PI / 2, 0, -0.027]} scale={0.013}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          <mesh geometry={nodes.piano_lod0_piano_0.geometry} material={materials.piano} rotation={[-Math.PI / 2, 0, 0]} scale={100} />
          <mesh geometry={nodes.tabouret_lod0_tabouret_0.geometry} material={materials.tabouret} position={[0, 0, 49.391]} rotation={[-Math.PI / 2, 0, 0]} scale={100} />
        </group>
      </group>
    </group>
  )
